...
export class ProductComponent implements OnInit {
  ...
  public search() {
    debugger
    // this._httpProviderService.get('/api/vtp/products?page=' + this.pageIndex + '&pageSize=' + this.pageSize + '&keyword=' + this.filterKeyword + '&categoryId=' + this.filterCategoryID)
    //   .subscribe((response: any) => {
    //     this.products = response.Items;
    //     this.pageIndex = response.PageIndex;
    //   }, error => this._httpProviderService.handleError(error));
    this._httpProviderService.get('/api/vtp/products')
    .subscribe((response: any) => {
  ...
  public showEdit(id: string) {
    this._httpProviderService.get('/api/product/detail/' + id).subscribe((response: any) => {
  ...
  public delete(id: string) {
    ...
    //   this._httpProviderService.delete('/api/product/delete', 'id', id).subscribe((response: any) => {
  ...
  private loadProductCategories() {
    this._httpProviderService.get('/api/productCategory/getallhierachy').subscribe((response: any[]) => {
  ...
  private saveData() {
    ...
    //   this._httpProviderService.post('/api/product/add', JSON.stringify(this.entity)).subscribe((response: any) => {
    //     this.search();
    ...
    // }
    // else {
    //   this._httpProviderService.put('/api/product/update', JSON.stringify(this.entity)).subscribe((response: any) => {
    //     this.search();
    //     this.addEditModal.hide();
  ...
  public deleteMulti() {
    ...
    // this.notificationService.printConfirmationDialog(MessageContstants.CONFIRM_DELETE_MSG, () => {
    //   this._httpProviderService.delete('/api/product/deletemulti', 'checkedProducts', JSON.stringify(checkedIds)).subscribe((response: any) => {
    //     this.notificationService.printSuccessMessage(MessageContstants.DELETED_OK_MSG);
    //     this.search();
    //   }, error => this._httpProviderService.handleError(error));
    // });
  ...
  public loadProductImages(id: number) {
    this._httpProviderService.get('/api/productImage/getall?productId=' + id).subscribe((response: any[]) => {
      this.productImages = response;
    }, error => this._httpProviderService.handleError(error));
  }
  public deleteImage(id: number) {
    // this.notificationService.printConfirmationDialog(MessageContstants.CONFIRM_DELETE_MSG, () => {
    //   this._httpProviderService.delete('/api/productImage/delete', 'id', id.toString()).subscribe((response: any) => {
    //     this.notificationService.printSuccessMessage(MessageContstants.DELETED_OK_MSG);
  ...
  public saveProductImage(isValid: boolean) {
    ...
    //       this._httpProviderService.post('/api/productImage/add', JSON.stringify(this.imageEntity)).subscribe((response: any) => {
    //         this.loadProductImages(this.imageEntity.ProductId);
    //         this.notificationService.printSuccessMessage(MessageContstants.CREATED_OK_MSG);
    //       });
    //     });
  ...
  public loadColors() {
    this._httpProviderService.get('/api/productQuantity/getcolors').subscribe((response: any[]) => {
      this.colors = response;
    }, error => this._httpProviderService.handleError(error));
  }
  public loadSizes() {
    this._httpProviderService.get('/api/productQuantity/getsizes').subscribe((response: any[]) => {
      this.sizes = response;
    }, error => this._httpProviderService.handleError(error));
  }

  public loadProductQuantities(id: number) {
    this._httpProviderService.get('/api/productQuantity/getall?productId=' + id + '&sizeId=' + this.sizeId + '&colorId=' + this.colorId).subscribe((response: any[]) => {
  ...
  public saveProductQuantity(isValid: boolean) {
    // if (isValid) {
    //   this._httpProviderService.post('/api/productQuantity/add', JSON.stringify(this.quantityEntity)).subscribe((response: any) => {
   ...
   public deleteQuantity(productId: number, colorId: string, sizeId: string) {
    ...
    // this.notificationService.printConfirmationDialog(MessageContstants.CONFIRM_DELETE_MSG, () => {
    //   this._httpProviderService.deleteWithMultiParams('/api/productQuantity/delete', parameters).subscribe((response: any) => {
    //     this.notificationService.printSuccessMessage(MessageContstants.DELETED_OK_MSG);
